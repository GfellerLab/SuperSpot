...
MC.well7$polygons <- supercell_metaspots_shape(MC = MC.well7,
                                                   spotpositions = spotPosition,
...
MC.well7.spl$polygons <- supercell_metaspots_shape(MC = MC.well7.spl,
                                                       spotpositions = spotPosition,
                                                       annotation = "Main_molecular_cell_type",
...
MC.well7_no_tresh.spl$polygons <- supercell_metaspots_shape(MC = MC.well7_no_tresh.spl,
                                                       spotpositions = spotPosition,
                                                       annotation = "Main_molecular_cell_type",
                                                       concavity = 2,membership_name = "membership")
