...
```{r}
bplot1 <- tibble(ARI = c(ari_matrix[1,2],graphst_ari_mean,
                         ari_matrix[1,3],STAGATE_ari_mean,
                         ari_matrix[1,4],cellcharter_ari_mean,
                         ari_matrix[1,5],dr.sc_ari_mean,
                         ari_matrix[1,6],bayespace_ari_mean),
...
bplot3 <- tibble(ARI = c(graphst_ari_mean_ms_vs_s,ari_matrix[2,c(3:6)],
                         STAGATE_ari_mean_ms_vs_s,ari_matrix[3,c(2,4:6)],
                         cellcharter_ari_mean_ms_vs_s,ari_matrix[4,c(2,3,5,6)],
                         dr.sc_ari_mean_ms_vs_s,ari_matrix[5,c(2:4,6)],
                         bayespace_ari_mean_ms_vs_s,ari_matrix[6,c(2:5)]), 
