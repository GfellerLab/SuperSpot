...
MC_DLS.spl <- SCimplify_SpatialDLS(X = mtx,spotPositions = spotPositions,method_similarity = "1", genes.use = hvg,gamma = 5 , n.pc = 1:30,method_knn = "1",k.knn = 6 , cell.annotation = dlpfc151673@meta.data$layer_guess , method_normalization = "log_normalize",split_not_connected = T)
