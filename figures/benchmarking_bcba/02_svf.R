...
processing <- function(g){
  ...
  obj <- readRDS(paste0("/work/FAC/FBM/LLB/dgfeller/scrnaseq/mteleman/SuperSpot/BCBA/Output/MC_seurat_g",g,".rds"))
...
saveRDS(mem.df,"/work/FAC/FBM/LLB/dgfeller/scrnaseq/mteleman/SuperSpot/BCBA/Output/results_memory_log_norm.rds")
write.csv(mem.df,"/work/FAC/FBM/LLB/dgfeller/scrnaseq/mteleman/SuperSpot/BCBA/Output/results_memory_log_norm.csv")
