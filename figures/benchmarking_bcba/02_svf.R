...
processing <- function(g){
  ...
  obj <- readRDS(paste0("./SuperSpot/BCBA/Output/MC_seurat_g",g,".rds"))
...
saveRDS(mem.df,"./SuperSpot/BCBA/Output/results_memory_log_norm.rds")
write.csv(mem.df,"./SuperSpot/BCBA/Output/results_memory_log_norm.csv")
